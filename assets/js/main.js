var Zepto = function() {
    ...
    function h(t) {
        var e, n;
        return A[t] || (e = P.createElement(t),
    ...
    var x, E, S, C, j, T, O = [], N = O.slice, L = O.filter, P = window.document, A = {}, k = {}, R = {
        "column-count": 1,
        columns: 1,
        "font-weight": 1,
        "line-height": 1,
        ...
        "z-index": 1,
        zoom: 1
    }, _ = /^\s*<(\w+|!)[^>]*>/, D = /^<(\w+)\s*\/?>(?:<\/\1>|)$/, H = /<(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^>]*)\/>/gi, z = /^(?:body|html)$/i, F = /([A-Z])/g, I = ["val", "css", "html", "text", "data", "width", "height", "offset"], Z = ["after", "prepend", "before", "append"], M = P.createElement("table"), $ = P.createElement("tr"), q = {
        ...
        th: $,
        "*": P.createElement("div")
    }, J = /complete|loaded|interactive/, U = /^[\w-]*$/, B = {}, V = B.toString, Y = {}, Q = P.createElement("div"), W = {
        tabindex: "tabIndex",
        readonly: "readOnly",
        "for": "htmlFor",
        "class": "className",
    ...
    Y.fragment = function(t, e, n) {
        var r, i, s;
        return D.test(t) && (r = S(P.createElement(RegExp.$1))),
        r || (t.replace && (t = t.replace(H, "<$1></$2>")),
        e === x && (e = _.test(t) && RegExp.$1),
        e in q || (e = "*"),
        s = q[e],
        s.innerHTML = "" + t,
        r = S.each(N.call(s.childNodes), function() {
            s.removeChild(this)
        })),
        o(n) && (i = S(r),
    ...
    ,
    Y.qsa = function(t, e) {
        var n, i = "#" == e[0], o = !i && "." == e[0], s = i || o ? e.slice(1) : e, a = U.test(s);
    ...
    S.fn = {
        ...
        closest: function(t, e) {
            var n = this[0]
              , i = !1;
            for ("object" == typeof t && (i = S(t)); n && !(i ? i.indexOf(n) >= 0 : Y.matches(n, t)); )
        ...
        css: function(e, n) {
            if (arguments.length < 2) {
                ...
                "string" == typeof e)
                    return i.style[j(e)] || r.getPropertyValue(e);
                if (X(e)) {
                    var o = {};
            ...
            var s = "";
            if ("string" == t(e))
                n || 0 === n ? s = u(e) + ":" + f(e, n) : this.each(function() {
                    this.style.removeProperty(u(e))
                });
            else
                for (E in e)
                    e[E] || 0 === e[E] ? s += u(E) + ":" + f(E, e[E]) + ";" : this.each(function() {
                        this.style.removeProperty(u(E))
                    });
            return this.each(function() {
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var t = this.offsetParent || P.body; t && !z.test(t.nodeName) && "static" == S(t).css("position"); )
                    t = t.offsetParent;
                return t
            })
        }
...
function(t) {
    ...
    function a(n, i, a, c, l, h, p) {
        ...
        i.split(/\s/).forEach(function(e) {
            ...
            i.i = m.length,
            m.push(i),
            "addEventListener"in n && n.addEventListener(s(i.e), i.proxy, o(i, p))
        })
    }
    function c(t, r, i, a, c) {
        ...
        (r || "").split(/\s/).forEach(function(e) {
            n(t, e, i, a).forEach(function(e) {
                delete v[u][e.i],
                "removeEventListener"in t && t.removeEventListener(s(e.e), e.proxy, o(e, c))
            })
        })
    }
    function u(e, n) {
    ...
    t.fn.triggerHandler = function(e, r) {
        ...
        return this.each(function(s, a) {
            ...
            i._args = r,
            i.target = a,
            t.each(n(a, e.type || e), function(t, e) {
                return o = e.proxy(i),
...
function(t) {
    ...
    function l(t) {
        ...
        t && (t == S ? "html" : t == E ? "json" : w.test(t) ? "script" : x.test(t) && "xml") || "text"
    }
    function f(t, e) {
    ...
    function d(e, n, r, i) {
        ...
        t.each(n, function(n, c) {
            ...
            !i && s ? e.add(c.name, c.value) : "array" == o || !r && "object" == o ? d(e, c, r, n) : e.add(n, c)
        })
    }
    var m, v, g = 0, y = window.document, b = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, w = /^(?:text|application)\/javascript/i, x = /^(?:text|application)\/xml/i, E = "application/json", S = "text/html", C = /^\s*$/, j = y.createElement("a");
    ...
    t.ajaxJSONP = function(e, n) {
        ...
        t(l).on("load error", function(o, c) {
            clearTimeout(i),
            t(l).off().remove(),
            "error" != o.type && r ? s(r[0], p, e, n) : a(null, c || "error", p, e, n),
            window[u] = f,
    ...
    t.ajax = function(e) {
        ...
        r(i),
        i.crossDomain || (n = y.createElement("a"),
        n.href = i.url,
        n.href = n.href,
        i.crossDomain = j.protocol + "//" + j.host != n.protocol + "//" + n.host),
        ...
        "jsonp" == p)
            return d || (i.url = f(i.url, i.jsonp ? i.jsonp + "=?" : i.jsonp === !1 ? "" : "callback=?")),
            t.ajaxJSONP(i, c);
        var g, b = i.accepts[p], w = {}, x = function(t, e) {
            w[t.toLowerCase()] = [t, e]
        }, E = /^([\w-]+:)\/\//.test(i.url) ? RegExp.$1 : window.location.protocol, S = i.xhr(), T = S.setRequestHeader;
        if (c && c.promise(S),
        i.crossDomain || x("X-Requested-With", "XMLHttpRequest"),
        x("Accept", b || "*/*"),
        (b = i.mimeType || b) && (b.indexOf(",") > -1 && (b = b.split(",", 2)[0]),
        S.overrideMimeType && S.overrideMimeType(b)),
        (i.contentType || i.contentType !== !1 && i.data && "GET" != i.type.toUpperCase()) && x("Content-Type", i.contentType || "application/x-www-form-urlencoded"),
        i.headers)
            for (v in i.headers)
                x(v, i.headers[v]);
        if (S.setRequestHeader = x,
        S.onreadystatechange = function() {
            if (4 == S.readyState) {
                ...
                if (S.status >= 200 && S.status < 300 || 304 == S.status || 0 == S.status && "file:" == E) {
                    ...
                    try {
                        "script" == p ? (0,
                        eval)(e) : "xml" == p ? e = S.responseXML : "json" == p && (e = C.test(e) ? null : t.parseJSON(e))
                    } catch (r) {
                        n = r
                    }
                    n ? a(n, "parsererror", S, i, c) : s(e, S, i, c)
                } else
                    a(S.statusText || null, S.status ? "error" : "abort", S, i, c)
            }
        }
        ,
        o(S, i) === !1)
    ...
    t.fn.load = function(e, n, r) {
        if (!this.length)
            return this;
        var i, o = this, s = e.split(/\s/), a = p(e, n, r), c = a.success;
        ...
        _scrollPage: function() {
            ...
            this.items.forEach(function(r, o) {
                classie.has(r, "shown") || classie.has(r, "animate") || !i(r, t.options.viewportFactor) || setTimeout(function() {
                    var i = n() + e() / 2;
                    if (t.el.style.WebkitPerspectiveOrigin = "50% " + i + "px",
                    t.el.style.MozPerspectiveOrigin = "50% " + i + "px",
                    t.el.style.perspectiveOrigin = "50% " + i + "px",
                    t._checkTotalRendered(),
                    t.options.minDuration && t.options.maxDuration) {
                        var o = Math.random() * (t.options.maxDuration - t.options.minDuration) + t.options.minDuration + "s";
                        r.style.WebkitAnimationDuration = o,
                        r.style.MozAnimationDuration = o,
                        r.style.animationDuration = o
                    }
        ...
        function r(e) {
            ...
            return t.each(c, function(t, r) {
                for (var t = 0; t < a.length; t++)
                    void 0 !== r[a[t]] && r[a[t]].toLowerCase().indexOf(e.toLowerCase()) !== -1 && (n.push(r),
                    t = a.length)
            }),
            n
        }
...
function(t, e) {
    ...
    var e, n, r, i, o = {}, s = "querySelector"in document && "addEventListener"in t, a = {
        ...
        "easeInOutQuad" === t && (n = e < .5 ? 2 * e * e : -1 + (4 - 2 * e) * e),
...
function() {
    for (var t = document.links, e = 0, n = t.length; e < n; e++)
...
function(t, e, n) {
    ...
    function i() {
        ...
        t = e.scrollY,
        t <= 500 && null != n && (n.style.transform = "translateY(" + -t / 3 + "px)",
